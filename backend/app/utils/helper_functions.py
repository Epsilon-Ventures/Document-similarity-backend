...
def prepare_response(response: dict, models: classmethod, query_encode: list) -> dict:
...
def prepare_response2(response: dict, models: classmethod, query_encode: list,i: int) -> dict:
        """Prepares the final response for the frontend
